...
@implementation ISIPropertyRepository

- (NSArray *) retrieveProperties {
  NSMutableArray * allProperties = [[NSMutableArray alloc] init];

  InspectionScheduleIpadProperty *p1 = [[InspectionScheduleIpadProperty alloc] init];
  ...
  InspectionScheduleIpadProperty *p2 = [[InspectionScheduleIpadProperty alloc] init];
  ...
  InspectionScheduleIpadProperty *p3 = [[InspectionScheduleIpadProperty alloc] init];
  ...
  InspectionScheduleIpadProperty *p4 = [[InspectionScheduleIpadProperty alloc] init];
  ...
  InspectionScheduleIpadProperty *p5 = [[InspectionScheduleIpadProperty alloc] init];
